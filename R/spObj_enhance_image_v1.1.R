...
if (Img_name == "ISPRS7") { 
  ...
  LCM_b_netto <- LCM_b_1[128:1789,146:2396]  #cut out of net-image ('ISPRS#7')
  #display(LCM_b_netto)
  LCM_b_netto2 <- imageData(LCM_b_netto)
  mx <- 1.136063 #determined by manual measurements in 'support_enhance_image_v1.1.R' 
  my <- 1.136444 #determined by manual measurements in 'support_enhance_image_v1.1.R' 
